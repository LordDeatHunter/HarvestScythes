...
public class RecipesGenerator {
    ...
    public static void createShapedRecipes() {
        ...
        SHAPED_RECIPES.put("wooden_scythe", new ShapedRecipeMaterials(new Identifier("planks"), Registry.ITEM.getId(Items.STICK), "tag", "item", Utils.ID("wooden_scythe")));
        SHAPED_RECIPES.put("stone_scythe", new ShapedRecipeMaterials(Registry.ITEM.getId(Items.COBBLESTONE), Registry.ITEM.getId(Items.STICK), "item", "item", Utils.ID("stone_scythe")));
        SHAPED_RECIPES.put("iron_scythe", new ShapedRecipeMaterials(Registry.ITEM.getId(Items.IRON_INGOT), Registry.ITEM.getId(Items.STICK), "item", "item", Utils.ID("iron_scythe")));
        SHAPED_RECIPES.put("golden_scythe", new ShapedRecipeMaterials(Registry.ITEM.getId(Items.GOLD_INGOT), Registry.ITEM.getId(Items.STICK), "item", "item", Utils.ID("golden_scythe")));
        SHAPED_RECIPES.put("diamond_scythe", new ShapedRecipeMaterials(Registry.ITEM.getId(Items.DIAMOND), Registry.ITEM.getId(Items.STICK), "item", "item", Utils.ID("diamond_scythe")));
    }
