...
public class MythicMetalsSupport {
    ...
    public static void loadRecipes() {
        ...
        RecipesGenerator.SHAPED_RECIPES.put("slowsilver_scythe", new ShapedRecipeMaterials(new Identifier("mythicmetals", "slowsilver_ingots"), HarvestScythes.STICK, "tag", HarvestScythes.STICK_TYPE, new Identifier(HarvestScythes.MOD_ID, "slowsilver_scythe")));
